		...
		<div className={styles.wrapper}>
			...
			<main className={styles.main}>
					...
					<Container className={styles.inner}>
						<div className={styles.content}>
							<div className={styles.aboutItem}>
								...
								<Typography tag='h3'>Fast and safe delivery</Typography>
								<Typography tag='p' color='black-light'>please login and buy our products, safe delivery guaranteed</Typography>
							</div>
							<div className={styles.aboutItem}>
							...
							<div className={styles.aboutItem}>
								...
								<Typography tag='h3'>24 hour customer service</Typography>
								<Typography tag='p' color='black-light'>Our customer service is ready to serve you at any time, don't hesitate to contact us</Typography>
							</div>
							<div className={styles.aboutItem}>
								...
								<Typography tag='p' color='black-light'>The price of the products we offer is very in accordance with the quality of the goods</Typography>
							</div>
							<Button
								variant='pink'
								size='s'
				...
				<section className={styles.shop}>
					<Container>
						<Typography className={styles.shopTitle} tag='h2' id='shop'>Various collections of furniture to fill your interior</Typography>
						<Typography tag='p' className={styles.shopDescription} color='black-light'>We provide a variety of goods with the best quality for you to find the right one to meet your interior needs</Typography>
						<ShopMenu />
						<Shop />
					</Container>
				</section>
				...
				<section className={styles.contact}>
					<Container className={styles.contactInner}>
						<Typography tag='h2'>Contact us if you need anything, we are ready to serve you</Typography>
						<Button variant='orange' size='m'>Contact us</Button>
					</Container>
				</section>
			</main>
			<Footer />
